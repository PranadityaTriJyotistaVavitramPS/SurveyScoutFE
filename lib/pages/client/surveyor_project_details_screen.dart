...
class SurveyorProjectDetailsScreen extends StatefulWidget {
  @override
  _SurveyorProjectDetailsScreenState createState() => _SurveyorProjectDetailsScreenState();}


class _SurveyorProjectDetailsScreenState extends State<SurveyorProjectDetailsScreen> {
        ...
        child: ListView(
          children: [
            ...
            _buildEditableTextField(
              ...
              icon: Iconify(AntDesign.profile_outline, color: Color(0xFF826754)),
              onChanged: (value) {
                _saveProjectTitle(value);
                setState(() {}); // Force UI to update
              },
            ...
            _buildEditableTextField(
              ...
              icon: Iconify(AntDesign.paper_clip_outline, color: Color(0xFF826754)),
              onChanged: (value) {
                _saveProjectTitle(value);
                setState(() {}); // Force UI to update
              },
